...
# GET STARTED
auc=readRDS("Results_AUC_object/auc_numbers_merged.rds")
setDT(auc)
...
write.csv(tcr_scor_filt10,"Results_clonotype_heatmap/reactivity_heatmap.csv")
...
dev.off()
write.csv(mat_scor_agg_lfc,"Results_clonotype_heatmap/per_pat_heatmap_stats_without_singlets.csv")
