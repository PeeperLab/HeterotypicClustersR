...
apc_data_filtered=readRDS("apc_data_filtered_fvf_corr.rds")
mm_filt=readRDS("final_mm_fvf_corr.rds")
dc_filt=readRDS("final_dc_fvf_corr.rds")
bcell_filt=readRDS("final_bcell_fvf_corr.rds")
...
pdf("./Results_APC_plots/dotplot_all_original_clusters.pdf", width=14.4, height=5.5)
DotPlot(apc_data_filtered, features=c(
  "FCN1","S100A8","S100A9", #mono cd14
  "PILRA", "FCGR3A", "HK3", #mono cd16
  "VCAN","TREM1","VEGFA","OLR1", # vcan
