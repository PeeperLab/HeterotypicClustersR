...
fig_path = "Results_Nichenet"
if(!dir.exists(fig_path)) dir.create(fig_path)

# # single cell signal R
load("extdata/database_curation/data_LRdb.rda")
setDT(LRdb)
LRdb[, lr_pair:= paste0(ligand,"_",receptor)]

# # celltalk_db
celltalk_db=fread("extdata/database_curation/human_lr_pair.txt")

# # cell chat - PPI
load("extdata/database_curation/PPI.human.rda")
...
load("extdata/database_curation/CellChatDB.human.rda")
...
uniprot_membrane=fread("extdata/database_curation/uniprotkb_cell_membrane_OR_surface_AND_2024_11_07.tsv")
...
fwrite(final_pairs[,.(from, to, lr_pair)], "Results_Nichenet/s0_potential_pairs.txt")
